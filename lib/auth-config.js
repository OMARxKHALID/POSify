...
export const authOptions = {
    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          }).populate("organizationId", "name slug status onboardingCompleted");
  ...
  callbacks: {
    ...
    // Redirect callback removed - we handle redirects manually in the login component
  },

  pages: {
    signIn: "/admin/login",
    // Remove error page redirect - we handle errors in the component
  },
