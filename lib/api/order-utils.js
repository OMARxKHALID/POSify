...
export const createOrderWithValidation = async (
  ...
  console.log("🔄 [DEBUG] createOrderWithValidation - Starting:", {
    organizationId,
    currentUserId,
    orderData: {
  ...
  console.log("🔄 [DEBUG] createOrderWithValidation - Items enriched:", {
    originalItemsCount: orderData.items?.length,
